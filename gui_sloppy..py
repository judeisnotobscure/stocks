...
class Stock_analyzer(Tk):
    ...
    def run(self):
        ...
        # Menu
        # self.file_menu = Menu(self.top_frame, tearoff=0, bg=self.menu_bkg, fg='black')
        # self.file_menu.add_command(label='Quit', command=self.quit)
        # self.mendu.add_cascade(label='File', menu=self.file_menu)
        ...
        self.price_range_button = Button(self.side_frame, text="Find Good Stocks", 
            command=lambda: self.thread_callback(self.get_stocks), state=DISABLED)
    ...
    def display_info(self):
        ...
        self.info_box.grid(self.side_frame,row=4,column=1,rowspan=3)
    ...
    def get_stocks(self):
        ...
        self.l.grid(row = 3, column = 1, pady = 4)
